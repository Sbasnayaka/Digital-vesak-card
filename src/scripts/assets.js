...
export const Assets = {
 ...
 // Updated to accept custom colors for variation
  getThorana: (c1 = "#f9d77e", c2 = "#ff8a5c", c3 = "#a2d5f2") => `
    <svg viewBox="0 0 800 600" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
      ...
      <defs>
        <radialGradient id="tGlow-${c1.replace('#','')}" cx="50%" cy="50%" r="50%">
      ...
      <circle cx="400" cy="300" r="150" fill="url(#tGlow-${c1.replace('#','')})" class="t-pulse" />

      <circle cx="400" cy="300" r="280" stroke="${c1}" stroke-width="12" stroke-dasharray="20 20" fill="none" class="t-spin-fast" filter="drop-shadow(0 0 10px ${c1})"/>
      <circle cx="400" cy="300" r="260" stroke="${c2}" stroke-width="8" stroke-dasharray="10 30" fill="none" class="t-spin-slow-rev" filter="drop-shadow(0 0 10px ${c2})"/>
      ...
      <circle cx="400" cy="300" r="200" stroke="${c1}" stroke-width="6" stroke-dasharray="40 10" fill="none" class="t-spin-slow-rev" filter="drop-shadow(0 0 8px ${c1})"/>
      <circle cx="400" cy="300" r="160" stroke="${c3}" stroke-width="10" stroke-dasharray="15 15" fill="none" class="t-spin-fast" filter="drop-shadow(0 0 10px ${c3})"/>

      <path d="M 120 300 Q 50 400 100 550" fill="none" stroke="${c1}" stroke-width="8" stroke-dasharray="10 20" class="t-spin-slow-rev" />
      <path d="M 140 300 Q 80 400 130 550" fill="none" stroke="${c2}" stroke-width="5" stroke-dasharray="5 10" class="t-spin-fast" />
      <path d="M 680 300 Q 750 400 700 550" fill="none" stroke="${c1}" stroke-width="8" stroke-dasharray="10 20" class="t-spin-slow-rev" />
      <path d="M 660 300 Q 720 400 670 550" fill="none" stroke="${c2}" stroke-width="5" stroke-dasharray="5 10" class="t-spin-fast" />

      <path d="M 400 350 Q 370 270 400 200 Q 430 270 400 350 Z" fill="#fff" class="t-pulse"/>
      <path d="M 400 350 Q 320 300 330 230 Q 370 280 400 350 Z" fill="${c1}" class="t-pulse"/>
      <path d="M 400 350 Q 480 300 470 230 Q 430 280 400 350 Z" fill="${c1}" class="t-pulse"/>
      
      <rect x="350" y="550" width="100" height="50" fill="#03060a" stroke="${c1}" stroke-width="2"/>
    </svg>
  `,
